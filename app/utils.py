...
def make_icon_app(icon: str, icon_name: str, icon_format: str, tmp_dir: str) -> ImageTk.PhotoImage:
    """
    ...
    ************************************************
    ...
    check_img_file: bool = check_tmp_directory_and_file(tmp_dir, for_check_tmp, icon_name_with_format)
